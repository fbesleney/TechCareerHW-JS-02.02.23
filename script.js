...
console.log('1. Soru /// Cevabı hmtl sayfasında :)')
...
customers.map(function(item){
  ...
  let tdSıraNo = document.createElement('td');
  tdSıraNo.innerHTML = index;
  index += 1; 
  ...
  trElement.appendChild(tdSıraNo);
...
console.log("2. Soru /// Customer Sayısı : ", customersLength);
  


// 3. a ( küçük veya büyük harf) ile başlayan customer'ları console a yaz.

let aNamedCustomers = customers.filter(x => x.contactName.toLowerCase().startsWith('a'));
    console.log('3. Soru /// Adı "a" veya "A" ile başlayan customerlar : ', aNamedCustomers);


// 4. Country 'UK' olan customerları console a yaz.

let customersCountry = customers.filter(w => w.address.country == "UK");
console.log('4. Soru /// Contry\'si "UK" olan customer\'lar : ',  customersCountry);


// 5. Customer'ları companyName e göre sırala.

let sortedCustomers = customers.sort((a,b) =>{
  return a.companyName.localeCompare(b.companyName);
});
console.log("5. Soru Customer'ları companyName'e göre sırala : ", sortedCustomers)


// 6.  id'si "DUMON" olan customer'ı console a yaz. tek bir object!  

let whoIsDumon = customers.find(y => y.id == "DUMON");
console.log('6. Soru /// Id\'si "DUMON" olan customer : ', whoIsDumon);


// 7. Telefon numarası 1 ile başlayanları console'a yaz.

let phoneNumbers = customers.filter(z => z.address.phone.substring(2).startsWith('1'));   // substring 16 adet buluyor
console.log('7. Soru /// Telefon numarası 1 ile başlayanlar : ', phoneNumbers, "substring 16 adet buluyor");

let phoneNumbers2 = customers.filter(z => z.address.phone.startsWith('(1'));   // (1 olarak start verilince 20 adet buluyor
console.log('7. Soru /// Telefon numarası 1 ile başlayanlar : ', phoneNumbers2, "(1 olarak start verilince 20 adet buluyor");

let phoneNumbers3 = customers.filter(z => z.address.phone.startsWith('1', 1));   // startsWith'e index yazınca da 24 adet buluyor
console.log('7. Soru /// Telefon numarası 1 ile başlayanlar : ', phoneNumbers3, "startsWith'e index yazınca da 24 adet buluyor");


// 8. Telefon numaralarını console a aşağıdaki formatta yaz "4065555834"


function getPhoneNumbers(x, y) {
  let allPhoneNumbers = [];
  for (var i=0; i < x.length ; i++)
    allPhoneNumbers.push(x[i]["address"][y].replace(/\D/g,"")); //burada adres yazmak fonksiyonu bozuyor ama index nosunu bulamadım :)) 4 yazdım olmuyor içerde denedim yine olmadı
  return allPhoneNumbers;
}

let result = getPhoneNumbers(customers, "phone");
console.log('8. Soru /// Telefon numaraları : ', result);
